...
import { GitUIManager } from './git-ui-manager';
...
export class GitPanel {
  ...
  async stageAllChangesWithConfirm() {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.showMessage(`ステージングに失敗: ${result.error}`, 'error');
      }
    } catch (error) {
  ...
  async pushToRemoteWithConfirm() {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.showMessage(`プッシュに失敗: ${result.error}`, 'error');
      }
    } catch (error) {
  ...
  async pullFromRemoteWithConfirm() {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.showMessage(`プルに失敗: ${result.error}`, 'error');
      }
    } catch (error) {
  ...
  async refreshStatus() {
    ...
    try {
      ...
      window.showMessage('Git状態の取得に失敗しました', 'error');
    }
  }
  ...
  async handleRemoteSetup() {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.showMessage(`リモート設定に失敗: ${result.error}`, 'error');
      }
    } catch (error) {
  ...
  async unstageFile(filePath, index) {
    try {
      ...
      if (result.success) {
        ...
        window.showMessage(`アンステージングに失敗: ${result.error}`, 'error');
      }
    } catch (error) {
